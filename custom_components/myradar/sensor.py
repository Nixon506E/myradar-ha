...
@dataclass
class MyRadarSensorEntityDescription(SensorEntityDescription):
    """Describes myRadar sensor entity."""
...
# Sensor Types    
SENSOR_TYPES: dict[str, MyRadarSensorEntityDescription] = {
    "summary": MyRadarSensorEntityDescription(
        key="summary",
        name="Summary",
        forecast_mode=["currently", "hourly", "daily"],
    ),
    "minutely_summary": MyRadarSensorEntityDescription(
        key="minutely_summary",
        name="Minutely Summary",
        forecast_mode=[],
    ),
    "hourly_summary": MyRadarSensorEntityDescription(
        key="hourly_summary",
        name="Hourly Summary",
        forecast_mode=[],
    ),
    "daily_summary": MyRadarSensorEntityDescription(
        key="daily_summary",
        name="Daily Summary",
        forecast_mode=[],
    ),
    "icon": MyRadarSensorEntityDescription(
        key="icon",
        name="Icon",
        forecast_mode=["currently", "hourly", "daily"],
    ),
    "nearest_storm_distance": MyRadarSensorEntityDescription(
    ...
    "nearest_storm_bearing": MyRadarSensorEntityDescription(
    ...
    "precip_type": MyRadarSensorEntityDescription(
        key="precip_type",
        name="Precip",
        icon="mdi:weather-pouring",
        forecast_mode=["currently", "minutely", "hourly", "daily"],
    ),
    "precip_intensity": MyRadarSensorEntityDescription(
    ...
    "precip_probability": MyRadarSensorEntityDescription(
    ...
    "precip_accumulation": MyRadarSensorEntityDescription(
    ...
    "temperature": MyRadarSensorEntityDescription(
        key="temperature",
        name="Temperature",
    ...
    "apparent_temperature": MyRadarSensorEntityDescription(
    ...
    "dew_point": MyRadarSensorEntityDescription(
        key="dew_point",
        name="Dew Point",
        device_class=SensorDeviceClass.TEMPERATURE,
        state_class=SensorStateClass.MEASUREMENT,
    ...
    "wind_speed": MyRadarSensorEntityDescription(
        key="wind_speed",
        name="Wind Speed",
    ...
    "wind_bearing": MyRadarSensorEntityDescription(
        key="wind_bearing",
        name="Wind Bearing",
        si_unit=DEGREE,
        us_unit=DEGREE,
    ...
    "wind_gust": MyRadarSensorEntityDescription(
        key="wind_gust",
        name="Wind Gust",
    ...
    "cloud_cover": MyRadarSensorEntityDescription(
        key="cloud_cover",
        name="Cloud Coverage",
        si_unit=PERCENTAGE,
        us_unit=PERCENTAGE,
    ...
    "humidity": MyRadarSensorEntityDescription(
        key="humidity",
        name="Humidity",
    ...
    "pressure": MyRadarSensorEntityDescription(
        key="pressure",
        name="Pressure",
    ...
    "visibility": MyRadarSensorEntityDescription(
        key="visibility",
        name="Visibility",
        si_unit=UnitOfLength.KILOMETERS,
        us_unit=UnitOfLength.MILES,
    ...
    "ozone": MyRadarSensorEntityDescription(
        key="ozone",
        name="Ozone",
    ...
    "apparent_temperature_max": MyRadarSensorEntityDescription(
    ...
    "apparent_temperature_high": MyRadarSensorEntityDescription(
    ...
    "apparent_temperature_min": MyRadarSensorEntityDescription(
    ...
    "apparent_temperature_low": MyRadarSensorEntityDescription(
    ...
    "temperature_max": MyRadarSensorEntityDescription(
        key="temperature_max",
    ...
    "temperature_high": MyRadarSensorEntityDescription(
    ...
    "temperature_min": MyRadarSensorEntityDescription(
        key="temperature_min",
    ...
    "temperature_low": MyRadarSensorEntityDescription(
        key="temperature_low",
    ...
    "precip_intensity_max": MyRadarSensorEntityDescription(
    ...
    "uv_index": MyRadarSensorEntityDescription(
        key="uv_index",
        name="UV Index",
        si_unit=UV_INDEX,
        us_unit=UV_INDEX,
    ...
    "moon_phase": MyRadarSensorEntityDescription(
        key="moon_phase",
        name="Moon Phase",
        icon="mdi:weather-night",
        forecast_mode=["daily"],
    ),
    "sunrise_time": MyRadarSensorEntityDescription(
        key="sunrise_time",
        name="Sunrise",
        icon="mdi:white-balance-sunny",
        forecast_mode=["daily"],
    ),
    "sunset_time": MyRadarSensorEntityDescription(
        key="sunset_time",
        name="Sunset",
        icon="mdi:weather-night",
        forecast_mode=["daily"],
    ),
    "alerts": MyRadarSensorEntityDescription(
        key="alerts",
        name="Alerts",
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend(
    {
        ...
        vol.Optional(MR_PLATFORM): cv.multi_select(
                  MR_PLATFORMS
              ),
        vol.Optional(MR_PREVPLATFORM): cv.string,
...
async def async_setup_entry(
    ...
    """Set up myRadar sensor entities based on a config entry."""
    ...
    # Round Output
    outputRound = domain_data[MR_ROUND]    
    
    sensors: list[MyRadarSensor] = []
    ...
    for condition in conditions:
        ...
        if not sensorDescription.forecast_mode or "currently" in sensorDescription.forecast_mode:
            ...
            sensors.append(MyRadarSensor(weather_coordinator, condition, name,  unique_id, forecast_day=None, forecast_hour=None, description=sensorDescription, requestUnits=requestUnits, outputRound=outputRound))
...
class MyRadarSensor(SensorEntity):
    """Class for a myRadar sensor."""

    #_attr_should_poll = False
    _attr_attribution = ATTRIBUTION
    entity_description: MyRadarSensorEntityDescription
    ...
    def __init__(
        ...
        forecast_day: int,
        forecast_hour: int,
        description:  MyRadarSensorEntityDescription,
        requestUnits: str,
        outputRound: str
    ) -> None:
    ...
    def available(self) -> bool:
        """Return if weather data is available from myRadar."""
    ...
    #    """Get the latest data from myRadar and updates the states."""
