"""Support for the myRadar service."""
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend(
    {
        ...
        vol.Optional(MR_PLATFORM): cv.string,
...
async def async_setup_platform(
    ...
    _LOGGER.warning(
        "Configuration of myRadar in YAML is deprecated "
    ...
    config_entry[MR_PLATFORM] = [MR_PLATFORMS[1]]
...
async def async_setup_entry(
    ...
    """Set up myRadar entity based on a config entry."""
    ...
    mr_weather = MyRadar(name, unique_id, forecast_mode, weather_coordinator, outputRound)

    async_add_entities([mr_weather], False)
    #_LOGGER.info(mr_weather.__dict__)
    

class MyRadar(WeatherEntity):
    """Implementation of an myRadar sensor."""
